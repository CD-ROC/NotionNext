...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是Li，来自中国四川成都。,生命这样的旅程，我渴求你的微笑来完整。欢迎来到我的网站！我将与大家分享我的科技、旅行、理财的见闻和心得，同时也会探讨成都生活吃喝玩乐相关的话题。🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'IndepThinker', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'LI', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.552355.zxy', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'IndepThinker LI, BLOG', // 网站关键词 英文逗号隔开
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo-api-omega-ten.vercel.app/', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Paul BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Email：paul@552355.xyz', // 站点描述，被notion中的页面描述覆盖
